...
<section class="hero-banner text-center">
	<div class="container">
		...
		<p class="hero-subtitle">برای برپاسازی یک سایت، اول از همه نیاز به یک مکان روی اینترنت داریم که بتوانیم فایل‌های سایت را روی آن بریزیم. </p>
			...
			<div class="col-md-9 col-lg-10 pl-2 pl-xl-5">
				<form class="form-inline flex-nowrap form-domainSearch">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="staticDomainSearch" placeholder="نام دامنه را وارد کنید">
					</div>
		...
		<div class="row">
			<div class="col-md-6 col-lg-4">
				<div class="card-feature card-feature-content">
					...
					<p>این فضا معمولاً یک رایانه است که اندکی با رایانه‌های خانگی متفاوت است. این رایانه که سرور (Server) نام دارد، همیشه به اینترنت متصل است و دارای یک نشانی IP ثابت می‌باشد</p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card-feature text-center">
					...
					<h3>سرور امن</h3>
					<p>برای برپاسازی یک سایت، اول از همه نیاز به یک مکان روی اینترنت داریم که بتوانیم فایل‌های سایت را روی آن بریزیم</p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card-feature text-center">
					...
					<h3>پشتیبان گیری</h3>
					<p>این فضا معمولاً یک رایانه است که اندکی با رایانه‌های خانگی متفاوت است. این رایانه که سرور (Server) نام دارد</p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card-feature text-center">
					...
					<h3>شخصی سازی</h3>
					<p>همیشه به اینترنت متصل است و دارای یک نشانی IP ثابت می‌باشد تا همیشه بتوان از طریق رایانه‌های دیگر به آن دسترسی داشت. </p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card-feature text-center">
					...
					<h3>انتقال رایگان</h3>
					<p> از نرم افزارهای خاصی هم بهره می‌برد که بتواند فایل‌های سایت را تبدیل به صفحات اینترنتی کند و خدمات جانبی را هم به صاحب سایت بدهد.</p>
				</div>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<div class="card-feature text-center">
					...
					<p> هاست هم نام برده می‌شود که در اصل اگر Host را به فارسی برگردانی کنیم، همان معنی و مفهوم فضای میزبانی را می‌دهد.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<p>بسته به کیفیت و منابع سخت افزاری هاست، انتخاب‌های زیادی پیش رو دارید که می‌توانید بسته به نیاز خود یک انتخاب را داشته باشید. علاوه بر آن شرکت‌ها و ارائه کنندگان بسیاری هستند</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<p>برخی از آنها معروف‌تر هستند، برخی دیگر هنوز نوپا هستند و در حال پیشرفت، برخی دیگر از نظر پشتیبانی شناخته‌تر هستند. </p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<p> این رایانه که سرور (Server) نام دارد، همیشه به اینترنت متصل است و دارای یک نشانی IP ثابت می‌باشد تا همیشه بتوان از طریق رایانه‌های دیگر به آن دسترسی داشت.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<p>این رایانه از نرم افزارهای خاصی هم بهره می‌برد که بتواند فایل‌های سایت را تبدیل به صفحات اینترنتی کند و خدمات جانبی را هم به صاحب سایت بدهد. </p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<h3>سرویس ایمیل</h3>
					<p>در اولین گام پس از ثبت دامنه یا نشانی اینترنتی، باید یک فضای میزبانی را هم تهیه کند. این فضا را معمولاً شرکت‌های ارائه دهندۀ فضای میزبانی یا هاستینگ (Hosting) می‌فروشند.</p>
				</div>
			</div>
			...
			<div class="col-lg-4 col-sm-6">
				<div class="card-service text-center">
					...
					<p>یعنی شما یک فضایی را برای مدت یک سال یا حتی چند ماه اجاره می‌کنید و سایت خود را روی آن برپا می‌کنید.</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-5 mb-5 mb-lg-0">
				<h2 class="mb-4">سرور <br class="d-none d-xl-block"> اختصاصی و امن <br class="d-none d-xl-block"> برای سایت شما</h2>
				<p>بسته به کیفیت و منابع سخت افزاری هاست، انتخاب‌های زیادی پیش رو دارید که می‌توانید بسته به نیاز خود یک انتخاب را داشته باشید. علاوه بر آن شرکت‌ها و ارائه کنندگان بسیاری هستند که هر کدام با شرایط خاص خود اقدام به خدمات هاستینگ می‌کنند. </p>
			</div>
			<div class="col-lg-7">
				<div class="text-center">
		...
		<div class="owl-carousel owl-theme testimonial">
			<div class="testimonial-item">
				<div class="media">
					...
					<div class="media-body">
						<p>نرم‌افزارهای مورد نیاز برای مدیریت بخشهای مختلف سایت و پست الکترونیک و… را در اختیار صاحبان وب سایتها قرار دهد.نرم‌افزارهای مورد نیاز برای مدیریت بخشهای مختلف سایت و پست الکترونیک </p>
						<h4>محمد امینی</h4>
			...
			<div class="testimonial-item">
				<div class="media">
					...
					<div class="media-body">
						<p>هر شخصی که نرم‌افزارهای لازم و دسترسی به این فایلها را داشته باشد امکان بازدید از این سایت را دارد. حال برای اینکه همه مردم امکان دسترسی به فایلها را داشته باشند نیاز است</p>
						<h4>علی احمدی</h4>
			...
			<div class="testimonial-item">
				<div class="media">
					...
					<div class="media-body">
						<p>در صورتی که حجم قابل توجهی از بازدیدکننده به سایت مراجعه کنند امکان پاسخگویی به همه آن‌ها را داشته باشد. بنابراین نیاز است تا یک کامپیوتر قدرتمند از لحاظ مشخصات قطعات داخلی باشد</p>
						<h4>جواد عزتی</h4>
			...
			<div class="testimonial-item">
				<div class="media">
					<img class="testimonial-img" src="front/pics/testimonial/testimonial3.png" alt="">
					<div class="media-body">
						<p>هر کامپیوتری می‌تواند یک سرور باشد اما از آنجا که هزینه‌های مورد نیاز برای فراهم کردن تجهیزات و نرم‌افزارهای لازم یا نیروی پشتیبانی برای صاحبان همه وبگاه‌ها به صرفه نیست .</p>
						<h4>سجاد کلانتری</h4>
			...
			<div class="testimonial-item">
				<div class="media">
					<img class="testimonial-img" src="front/pics/testimonial/testimonial2.png" alt="">
					<div class="media-body">
						<p>سرویسهای میزبانی وب بر اساس نوع سیستم‌عاملی که بر روی سرورها نصب می‌باشد و طبیعتاً نرم‌افزارها و فایلهایی را که پشتیبانی می‌کنند شاخه بندی می‌شوند. مانند هُست ویندوز…</p>
						<h4>علی کریمی</h4>
